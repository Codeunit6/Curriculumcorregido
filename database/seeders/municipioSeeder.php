    ...
    public function run(): void
    {
        $estados = array(
            ...
            "Oaxaca" => array(
                ...
                "San Juan Sayultepec",
                "San Juan Tabaá",
                "San Juan TamFrancisco Cahuacuá",
                "San Francisco Cajonos",
                "San Francisco Chapulapa",
                "San Francisco Chindúa",
                "San Francisco del Mar",
        ...
        foreach ($estados as $nombre_estado => $municipios) {
            foreach ($municipios as $nombre_municipio) {
                ...
                $estado->Nombre = $nombre_municipio;
                $estado->state_id = $state_id;
                $estado->save();
            }
        }
    }
